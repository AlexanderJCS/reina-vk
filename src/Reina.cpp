...
Reina::Reina() {
    ...
    std::vector<ObjectProperties> objectProperties{
            ...
            {models.getModelRange(0).indexOffset, glm::vec3(1), glm::vec3(1), models.getModelRange(0).tbnsIndexOffset,    models.getModelRange(0).texIndexOffset, 1.5f, true, 0.7, -1, -1, -1, 0u}
    };
