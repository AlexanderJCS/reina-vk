...
//    scene = reina::scene::gltf::loadScene(logicalDevice, physicalDevice, commandPool, graphicsQueue, "scenes/avocado/avocados.glb");
    ...
    reina::scene::Material subjectMaterial{3, -1, -1, -1, glm::vec3(1.0f), glm::vec3(0.0f), 0.0f, 0.0f, true, 0.0f, true};
    reina::scene::Material lightMaterial{0, -1, -1, -1, glm::vec3(0.9f), glm::vec3(16.0f), 0.0f, 0.0f, false, 0.0f, false};
